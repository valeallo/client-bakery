...
const ProductCard = ({product}) => {
  ...
  return (<>
        <div className="relative h-250 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md  hover:scale-105 transition-transform duration-300">
            ...
            className="absolute bottom-3 left-2 flex items-center w-[95%] justify-center rounded-md bg-[#e68d8d] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-[#dc6262] focus:outline-none focus:ring-4 ">
